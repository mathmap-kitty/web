...
<div class="foot">資料整理自《學測數學考題分析 106–115》· 本頁為趨勢分析，題目全文以大考中心原卷為準。</div><div style="text-align:center;font-size:12.5px;color:#9a857c;padding:0 14px 30px">mathmap 數學地圖 © Kitty</div>
</div>
<script>{js}</script>
<script>{js2}</script>
<script>{js3}</script>
