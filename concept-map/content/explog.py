...
UNIT = {
    ...
    "kps": [
        {
            "num": "考點 1", "id": "kp1", "nav": "指數律與指數方程", "freq": "★★☆",
            "title": r"指數律與指數方程",
        ...
        {
            "num": "考點 2", "id": "kp2", "nav": "對數的定義與運算", "freq": "★★☆",
        ...
        {
            "num": "考點 3", "id": "kp3", "nav": "常用對數（科學記號、位數）", "freq": "★★☆",
        ...
        {
            "num": "考點 4", "id": "kp4", "nav": "指數對數函數圖形", "freq": "★★★ 必考",
            "title": r"指數與對數函數的圖形",
        ...
        {
            "num": "考點 5", "id": "kp5", "nav": "應用模型與數列結合", "freq": "★★★ 必考",
            ...
            "prereq": [
                ...
                r"**三點共線 \(\Leftrightarrow\) 兩兩斜率相等**（直線與圓單元 考點 1）——\(115\) 選15「\(x\) 等距 \(\Rightarrow\) 共線⟺\(y\) 成等差」的依據",
            ],
            "points": [
