...
UNIT = {
    ...
    "kps": [
        {
            "num": "考點 1", "id": "kp1", "nav": "三角比、弧度與廣義角", "freq": "★★☆",
            "title": r"三角比、弧度與廣義角",
        ...
        {
            "num": "考點 2", "id": "kp2", "nav": "正弦定理、餘弦定理", "freq": "★★★ 必考",
            "title": r"正弦定理與餘弦定理",
        ...
        {
            "num": "考點 3", "id": "kp3", "nav": "三角測量與幾何應用", "freq": "★★☆",
            "title": r"三角測量與平面幾何應用",
        ...
        {
            "num": "考點 4", "id": "kp4", "nav": "三角函數圖形（疊合、對稱）", "freq": "★★★ 必考",
        ...
        {
            "num": "考點 5", "id": "kp5", "nav": "和差角、倍角", "freq": "★★★ 必考",
        ...
        {
            "num": "考點 6", "id": "kp6", "nav": "角平分線、面積比與相似", "freq": "★★☆",
        ...
        {
            "num": "考點 7", "id": "kp7", "nav": "圓周角與二面角中的三角", "freq": "★★☆",
            "title": r"圓周角與二面角中的三角",
