...
※ 本檔目前含 Part 0＋核心概念 1（三角比/弧度）；核心概念 2–7 與 Part 2/3 待補。
"""
...
UNIT = {
    ...
    "title": "三角",
    "exam_tag": "115 學測",
    "hero_sub": "Part 1 七大核心概念 ｜ Part 2 模擬實戰 ｜ Part 3 考前速查",
    ...
    "part0": {
        ...
        "challenge": {
            ...
            "answer": 1,
            "reveal": r"直覺說 \(1+1=2\)，但兩個波的最高點 **不同時發生**——錯開的兩波合成一個新波，振幅是 \(\sqrt{1^2+1^2}=\sqrt2\)。這就是核心概念 4 的「疊合」。",
            "kp": "kp4",
        },
        ...
        "map": r"七大核心概念：① 三角比、弧度與廣義角 ② 正弦／餘弦定理 ③ 三角測量與幾何應用 ④ 三角函數圖形（週期、對稱、疊合）⑤ 和差角／倍角（解方程與不等式）⑥ 三角形面積、相似與角平分線 ⑦ 圓周角與二面角中的三角。",
    },
    ...
    "kps": [
        {
            "num": "核心概念 1", "id": "kp1", "nav": "三角比、弧度與廣義角", "freq": "★★☆",
            "title": r"三角比、弧度與廣義角",
            "intro": r"**三角比就是直角三角形『邊的比例』**：角度固定，三角形放大縮小比值都一樣——對邊÷斜邊這個比值就叫 \(\sin\theta\)。\(\sin=\dfrac{對邊}{斜邊}\)、\(\cos=\dfrac{鄰邊}{斜邊}\)、\(\tan=\dfrac{對邊}{鄰邊}\)。把它從銳角推廣到任意角（廣義角：**值看與 \(x\) 軸的夾角、正負看象限**），再把角度量改用弧度，就是本核心概念。",
            "prereq": [
        ...
        {
            "num": "核心概念 2", "id": "kp2", "nav": "正弦定理、餘弦定理", "freq": "★★★ 必考",
            "title": r"正弦定理與餘弦定理",
        ...
        {
            "num": "核心概念 3", "id": "kp3", "nav": "三角測量與幾何應用", "freq": "★★☆",
            "title": r"三角測量與平面幾何應用",
        ...
        {
            "num": "核心概念 4", "id": "kp4", "nav": "三角函數圖形（疊合、對稱）", "freq": "★★★ 必考",
            "title": r"三角函數圖形：週期、對稱與疊合",
            "intro": r"**疊合＝把兩個波合成一個波**：\(a\sin x+b\cos x\) 看似兩條，其實能併成**一條**正弦波 \(\sqrt{a^2+b^2}\sin(x+\varphi)\)。為什麼振幅是 \(\sqrt{a^2+b^2}\)？把係數 \((a,b)\) 想成坐標，這正是它到原點的長度（畢氏！）。一旦併成一條，**最大值就是 \(\sqrt{a^2+b^2}\)**、週期與對稱軸也都看得出來。這是本核心概念的王牌。",
            "prereq": [
                r"**和角公式** \(\sin(x+\varphi)=\sin x\cos\varphi+\cos x\sin\varphi\)（核心概念 5，疊合的原理）",
        ...
        {
            "num": "核心概念 5", "id": "kp5", "nav": "和差角、倍角", "freq": "★★★ 必考",
        ...
        {
            "num": "核心概念 6", "id": "kp6", "nav": "角平分線、面積比與相似", "freq": "★★☆",
            "title": r"三角形面積比、相似與角平分線",
            "intro": r"**這個核心概念都在算『比』**。最常考的角平分線定理：\(\angle A\) 的平分線把對邊 \(BC\) 分成的兩段，比例剛好等於**兩條鄰邊之比** \(AB:AC\)（不是切一半！）。面積比的關鍵：**等高的兩個三角形，面積比＝底之比**；夾角相同就用 \(\dfrac12ab\sin C\) 比。相似三角形的**面積比是邊長比的平方**。",
            "prereq": [
                r"**三角形面積** \(\dfrac12\times底\times高\)、\(\dfrac12ab\sin C\)（核心概念 2）",
                r"**比例與相似**的基本概念",
                r"**內分點**：會把一段長按比例分配",
            ],
            "points": [
        ...
        {
            "num": "核心概念 7", "id": "kp7", "nav": "圓周角與二面角中的三角", "freq": "★★☆",
            "title": r"圓周角與二面角中的三角",
            ...
            "prereq": [
                ...
                r"**正弦定理** \(\dfrac{a}{\sin A}=2R\)（核心概念 2）",
                r"**餘角** \(\cos(90°-\theta)=\sin\theta\)（核心概念 1）",
            ],
            "points": [
                {"label": r"圓周角定理", "lines": [
    ...
    "part2": {
        "count": "10", "note": "涵蓋七大核心概念 · 建議自行限時 40 分鐘作答後再對照詳解",
        "groups": [
