...
UNIT = {
    ...
    "kps": [
        {
            "num": "考點 1", "id": "kp1", "nav": "空間坐標與距離", "freq": "★★☆",
        ...
        {
            "num": "考點 2", "id": "kp2", "nav": "內積與垂直", "freq": "★★☆",
        ...
        {
            "num": "考點 3", "id": "kp3", "nav": "外積與體積", "freq": "★★★ 必考",
                ...
                {"tag": "111 數A · 選填 17", "level": "★★★（難）", "core": "平行六面體最大體積：底面積（外積）× 到底面距離",
                 ...
                 "solution": {"brief": r"\(21\)",
                              "steps": [
                                  ...
                                  r"\(x^2+y^2=1\) 上 \(\max(8x-6y)=\sqrt{8^2+6^2}=10\)（柯西不等式，見平面向量單元 考點 3；或設 \((x,y)=(\cos\theta,\sin\theta)\) 疊合），故最大體積 \(=10+11=21\)。"]}},
            ],
            "selfcheck": {
        ...
        {
            "num": "考點 6", "id": "kp6", "nav": "二面角與立體", "freq": "★★☆",
            "title": r"二面角與立體（摺疊問題）",
