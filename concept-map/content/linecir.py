...
UNIT = {
    ...
    "kps": [
        {
            "num": "考點 1", "id": "kp1", "nav": "直線方程式與斜率", "freq": "★★★ 必考",
            # ⚠️ 待老師確認：這個考點同時含「點到直線距離」（intro 說是本單元最高頻工具），
            # 所以它其實跨方向／方程／距離三格。標成「方向 ▸ 方程」是取考點名稱的主軸；
            # 若老師認為距離才是學生最常從這裡切入的，可改成「方向 ▸ 距離」。
            "axis": ["方向", "方程"],
        ...
        {
            "num": "考點 2", "id": "kp2", "nav": "兩點距離與三角形", "freq": "★★☆",
            "axis": ["距離", "方程"],
            "title": r"兩點距離、中點與三角形",
        ...
        {
            "num": "考點 4", "id": "kp4", "nav": "直線與圓的位置", "freq": "★★★ 必考",
            "axis": ["距離", "方程"],
            ...
            "prereq": [
                ...
                r"**圓心、半徑**（考點 3）",
                r"**畢氏定理**（弦長、切線長都靠它）",
                r"圓的參數式 \((\cos\theta,\sin\theta)\) 與 **疊合**（三角單元 考點 1、4）——\(108\) 單1 會用",
            ],
            "points": [
        ...
        {
            "num": "考點 5", "id": "kp5", "nav": "平面區域與線性規劃", "freq": "★★☆",
            "axis": ["區域", "方程"],
            "title": r"平面區域與線性規劃",
