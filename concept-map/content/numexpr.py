...
UNIT = {
    ...
    "kps": [
        {
            "num": "考點 1", "id": "kp1", "nav": "實數系與有理／無理", "freq": "★★☆",
        ...
        {
            "num": "考點 2", "id": "kp2", "nav": "絕對值", "freq": "★★★ 必考",
        ...
        {
            "num": "考點 3", "id": "kp3", "nav": "數線、距離與根號估算", "freq": "★★☆",
        ...
        {
            "num": "考點 4", "id": "kp4", "nav": "乘法公式與算幾不等式", "freq": "★★☆",
        ...
        {
            "num": "考點 5", "id": "kp5", "nav": "比例、百分率與加權平均", "freq": "★☆☆",
        ...
        {
            "num": "考點 6", "id": "kp6", "nav": "高斯（最大整數）函數", "freq": "★★☆",
            "title": r"高斯函數（最大整數函數）",
