...
UNIT = {
    ...
    "part0": {
        ...
        "fig": {"svg": SVG_REALTREE, "full": True, "caption": r"實數系概念圖：循著分支判定一個數的歸類，藍字為各層的關鍵性質與提醒（進核心概念前先建立全貌）"},
    },

    "kps": [
        {
            "num": "核心概念 1", "id": "kp1", "nav": "實數系與有理／無理", "freq": "★★☆",
            ...
            "prereq": [
                ...
                r"**絕對值＝距離**（核心概念 2）、**根號估算與平方比大小**（核心概念 3）——\(112\) 數B多9 的 (3)(4)(5) 會用",
            ],
            "points": [
        ...
        {
            "num": "核心概念 2", "id": "kp2", "nav": "絕對值", "freq": "★★★ 必考",
            ...
            "prereq": [
                ...
                r"「**距離**」的概念",
                r"解一次方程／不等式",
                r"**二次不等式**「兩根內／外」（多項式單元 核心概念 2）——平方去絕對值後會解到二次（\(111\) 多7）",
            ],
            "points": [
        ...
        {
            "num": "核心概念 3", "id": "kp3", "nav": "數線、距離與根號估算", "freq": "★★☆",
        ...
        {
            "num": "核心概念 4", "id": "kp4", "nav": "乘法公式與算幾不等式", "freq": "★★☆",
            "title": r"乘法公式、對稱式求值與算幾不等式",
            "intro": r"把「展開、對稱式求值、用算幾求極值」三件代數工具練熟——這是數與式裡計算量最大、也最常和幾何結合的核心概念。",
            "prereq": [
                r"**乘法分配律、展開**",
                r"**完全平方** \((a+b)^2\) 的概念",
                r"**根號** \(\sqrt{ab}\)（算幾不等式用）",
        ...
        {
            "num": "核心概念 5", "id": "kp5", "nav": "比例、百分率與加權平均", "freq": "★☆☆",
            ...
            "questions": [
                ...
                {"tag": "107 舊制 · 單選 6", "level": "★★☆（中）", "core": "百分率的連乘（漲跌幅）",
                 ...
                 "options": [r"\(120=x\lt y\lt180\)", r"\(120\lt x\lt y\lt180\)", r"\(x\lt120\lt y\lt180\)", r"\(120=x\lt180\lt y\)", r"\(120\lt x\lt180\lt y\)"],
        ...
        },
        {
            ...
            "worked": {
                ...
                "steps": [
                    {"do": r"先把 \(\sqrt{99}\) 夾在相鄰平方數之間：\(81=9^2<99<100=10^2\Rightarrow9<\sqrt{99}<10\)。",
                     "why": r"算 \([\sqrt N]\) 先用根號估算「框整數」（核心概念 3 的技巧）。"},
            ...
            "strategy": [
                r"算 \([\sqrt N]\) 先把 \(\sqrt N\) **夾在相鄰平方數之間**（核心概念 3 的技巧），再取整數部分。",
