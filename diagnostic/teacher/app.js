(function(){
  ...
  var UNITS={
    ...
    comb:{name:'排列組合',kp:['計數原理與系統列舉','排列與位置限制','組合、重複組合與分組','分類計數與結果等價']},
    probability:{name:'機率',kp:['樣本空間與古典機率','事件運算、餘事件與獨立','條件機率、全機率與貝氏','隨機變數與期望值']},
    ...
    trig:{name:'三角比與三角函數',kp:['三角比、弧度與廣義角','正弦定理、餘弦定理','三角測量與幾何應用','三角函數圖形','和差角、倍角','角平分線、面積比與相似','圓周角與二面角中的三角']},
