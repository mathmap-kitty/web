    ...
    "kps": [
        {
            ...
            "title": r"三角比、弧度與廣義角",
            "intro": r"**三角比就是直角三角形『邊的比例』**：角度固定，三角形放大縮小比值都一樣——對邊÷斜邊這個比值就叫 \(\sin\theta\)。\(\sin=\dfrac{對邊}{斜邊}\)、\(\cos=\dfrac{鄰邊}{斜邊}\)、\(\tan=\dfrac{對邊}{鄰邊}\)（記「SOH-CAH-TOA」）。把它從銳角推廣到任意角（廣義角看象限定正負），再把角度量改用弧度，就是本考點。",
            "prereq": [
            ...
            "worked": {
                ...
                "steps": [
                    ...
                    {"do": r"\(\sin B=\dfrac{對邊}{斜邊}=\dfrac35\)、\(\cos B=\dfrac{鄰邊}{斜邊}=\dfrac45\)、\(\tan B=\dfrac{對邊}{鄰邊}=\dfrac34\)。",
                     "why": r"直接套定義 SOH-CAH-TOA。"},
                ],
                "ans": r"\(\sin B=\dfrac35,\ \cos B=\dfrac45,\ \tan B=\dfrac34\)",
            },
            "questions": [
        ...
        },
        {
            ...
            "title": r"正弦定理與餘弦定理",
            "intro": r"**餘弦定理其實是畢氏定理的『加強版』**：直角三角形 \(c^2=a^2+b^2\)；當夾角 \(C\) 不是直角，就多補一項 \(c^2=a^2+b^2-2ab\cos C\)（\(C=90°\) 時 \(\cos C=0\)，正好退回畢氏定理！）。正弦定理則把「邊」與「對角的 \(\sin\)」綁在一起。**看給什麼選工具**：兩角一邊→正弦定理；兩邊夾角或三邊→餘弦定理。三角 **★★★ 必考核心**。",
            "prereq": [
            ...
            "worked": {
                ...
                "steps": [
                    {"do": r"給的是「兩角一邊」，用正弦定理 \(\dfrac{a}{\sin A}=\dfrac{b}{\sin B}\)。",
                     "why": r"正弦定理把每條邊和它「對角的 \(\sin\)」綁在一起；給兩角一邊正好用它。"},
        ...
        },
        {
            ...
            "worked": {
                ...
                "ans": r"最大值 \(2\)，即 \(y=2\sin\left(x+\dfrac\pi6\right)\)",
            },
            "questions": [
